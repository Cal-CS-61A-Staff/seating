...
def main(program, bcourses_cookie):
	...
	# 3. Find a GET request to junction.berkeley.edu and copy its "Cookie" field. The cookie should begin with "_calcentral_session".
	...
	course_info = json.loads(urlopen(server + "/api/academics/rosters/canvas/embedded", cookie=bcourses_cookie).read())
